...
#ifndef liblldb_NativeProcessAndroid_H_
#define liblldb_NativeProcessAndroid_H_
...
namespace lldb_private
{
    ...
    class NativeProcessAndroid: public NativeProcessProtocol
    {
    public:
        ...
        /// dependent) offset.
        ///
        /// This method is provided for use by RegisterContextAndroid derivatives.
        bool
    ...
    private:
        ...
        {
            OperationArgs(NativeProcessAndroid *monitor);

            ~OperationArgs();

            NativeProcessAndroid *m_monitor;      // The monitor performing the attach.
        ...
        {
            LaunchArgs(NativeProcessAndroid *monitor,
        ...
        {
            AttachArgs(NativeProcessAndroid *monitor,
                       lldb::pid_t pid);
...
#endif // #ifndef liblldb_NativeProcessAndroid_H_
