...
#ifndef liblldb_NativeThreadAndroid_H_
#define liblldb_NativeThreadAndroid_H_
...
namespace lldb_private
{
    ...
    class NativeThreadAndroid : public NativeThreadProtocol
    {
        friend class NativeProcessAndroid;

    public:
        NativeThreadAndroid (NativeProcessAndroid *process, lldb::tid_t tid);
...
#endif // #ifndef liblldb_NativeThreadAndroid_H_
